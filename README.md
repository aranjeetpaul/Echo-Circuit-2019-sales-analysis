...
> For more of my projects and Data Journey, visit the rest of my [GitHub](https://github.com/aranjeetpaul). Or to see my Data Visualisation and Storytelling skills, visting my [Tableau Public](https://public.tableau.com/app/profile/aranjeet.paul/vizzes) for an Emergency Room Dashboard with..... Feel free to follow me on [LinkedIn](https://www.linkedin.com/in/aranjeet-paul/)!
...
- Unfortunatley, the issues with **`loyalty_id`** and **`loyalty`** columns can't be fixed. To remedy this I will need to discuss with stakeholders and have access to data before data migration. For the time being, I will assume **`loyalty_id`**'s aren't corrupted and trust the **`loyalty`** statuses as they are.
...
- See the visualisations used in this README.md in the [Visualisations](Visualisations/) folder. If you want the Tableau Workbook used to generate the visualisations, please see the [Analysis and Visualisation](Data%20Cleaning%20%26%20Analysis/Analysis%20and%20Visualisations.twbx) folder.
